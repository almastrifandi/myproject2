...
<body class="text-black font-poppins  ">
    <div class="bg-neutral-900 text-white mx-14 rounded-lg mt-7 ">
        ...
        <div class="video-player relative flex flex-nowrap gap-5">
            ...
            <div class="video-player-sidebar flex flex-col shrink-0 w-[330px] h-[470px] bg-[#F5F8FA] rounded-[20px] px-5 gap-5 pb-0 overflow-y-scroll no-scrollbar">
                ...
                <div class="flex flex-col gap-3">
                    <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#ea580c] rounded-full hover:bg-[#ea580c] transition-all duration-300">
